...
CREATE TABLE IF NOT EXISTS `ys_app` (
...
INSERT INTO `ys_app` (`appid`, `appname`, `appthumb`, `appstatus`, `appsetting`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_area` (
...
INSERT INTO `ys_area` (`areaid`, `area`, `areacode`, `arealevel`) VALUES
(1, '全国', 1, 1),
(3, '河南', 373, 0),
(4, '北京', 10, 0),
(5, '陕西', 29, 0),
...
CREATE TABLE IF NOT EXISTS `ys_basic` (
...
INSERT INTO `ys_basic` (`basicid`, `basic`, `basicareaid`, `basicsubjectid`, `basicsection`, `basicknows`, `basicexam`, `basicapi`, `basicdemo`, `basicthumb`, `basicprice`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_block` (
...
INSERT INTO `ys_block` (`blockid`, `block`, `blocktype`, `blockposition`, `blockcontent`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_content` (
...
INSERT INTO `ys_coupon` (`couponsn`, `couponvalue`, `couponstatus`, `couponaddtime`, `couponendtime`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_examhistory` (
...
CREATE TABLE IF NOT EXISTS `ys_exams` (
...
INSERT INTO `ys_exams` (`examid`, `examsubject`, `exam`, `examsetting`, `examquestions`, `examscore`, `examstatus`, `examtype`, `examauthorid`, `examauthor`, `examtime`, `examkeyword`, `examdecide`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_examsession` (
...
CREATE TABLE IF NOT EXISTS `ys_favor` (
...
CREATE TABLE IF NOT EXISTS `ys_gbook` (
...
INSERT INTO `ys_gbook` (`gbid`, `gbinfo`, `gbcontent`, `gbreply`, `gbtime`, `gbreplytime`, `gbstatus`) VALUES
(1, '', '请站长联系我', '&lt;p&gt;\r\n	站长马上就联系你&lt;/p&gt;', 0, 0, 1),
...
CREATE TABLE IF NOT EXISTS `ys_knows` (
...
INSERT INTO `ys_knows` (`knowsid`, `knows`, `knowssectionid`, `knowsdescribe`, `knowsstatus`) VALUES
(1, '抗战史', 1, '', 1),
(2, '策略', 1, '', 1),
(3, '时事', 1, '', 1),
(4, '历史', 2, '', 1),
...
CREATE TABLE IF NOT EXISTS `ys_module` (
...
INSERT INTO `ys_module` (`moduleid`, `modulecode`, `modulename`, `moduledescribe`, `moduleapp`, `moduletable`, `moduleallowreg`, `modulestatus`) VALUES
...
--
-- 表的结构 `ys_module_fields`
--

CREATE TABLE IF NOT EXISTS `ys_module_fields` (
...
--
-- 转存表中的数据 `ys_module_fields`
--

INSERT INTO `ys_module_fields` (`fieldid`, `fieldappid`, `fieldmoduleid`, `fieldsequence`, `field`, `fieldtitle`, `fieldlength`, `fielddescribe`, `fieldtype`, `fieldhtmltype`, `fieldhtmlproperty`, `fieldvalues`, `fielddefault`, `fieldlock`, `fieldindextype`, `fieldforbidactors`, `fieldsystem`, `fieldpublic`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_openbasics` (
...
--
-- 转存表中的数据 `ys_openbasics`
--

INSERT INTO `ys_openbasics` (`obid`, `obuserid`, `obbasicid`, `obtime`, `obendtime`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_orders` (
...
CREATE TABLE IF NOT EXISTS `ys_poscontent` (
...
CREATE TABLE IF NOT EXISTS `ys_position` (
...
INSERT INTO `ys_product` (`productid`, `producttype`, `productpartnerid`, `productname`, `productcode`, `productprice`, `productdescribe`, `productlesson`, `producttry`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_quest2knows` (
...
--
-- 转存表中的数据 `ys_quest2knows`
--

INSERT INTO `ys_quest2knows` (`qkid`, `qkquestionid`, `qkknowsid`, `qktype`) VALUES
(1, 1, 1, 0),
(2, 2, 1, 0),
(3, 3, 1, 0),
(4, 4, 1, 0),
...
--
-- 表的结构 `ys_questionrows`
--

CREATE TABLE IF NOT EXISTS `ys_questionrows` (
...
--
-- 转存表中的数据 `ys_questionrows`
--

INSERT INTO `ys_questionrows` (`qrid`, `qrtype`, `qrquestion`, `qrknowsid`, `qrlevel`, `qrnumber`, `qruserid`, `qrusername`, `qrlastmodifyuser`, `qrtime`, `qrstatus`) VALUES
...
--
-- 转存表中的数据 `ys_questions`
--

INSERT INTO `ys_questions` (`questionid`, `questiontype`, `question`, `questionuserid`, `questionusername`, `questionlastmodifyuser`, `questionselect`, `questionselectnumber`, `questionanswer`, `questiondescribe`, `questionknowsid`, `questioncreatetime`, `questionstatus`, `questionhtml`, `questionparent`, `questionsequence`, `questionlevel`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_questype` (
...
INSERT INTO `ys_questype` (`questid`, `questype`, `questsort`, `questchoice`) VALUES
(1, '单选题', 0, 1),
(2, '多选题', 0, 2),
(3, '判断题', 0, 4),
(4, '问答题', 1, 1),
...
CREATE TABLE IF NOT EXISTS `ys_record` (
...
CREATE TABLE IF NOT EXISTS `ys_reply` (
...
CREATE TABLE IF NOT EXISTS `ys_sections` (
...
INSERT INTO `ys_sections` (`sectionid`, `section`, `sectionsubjectid`, `sectiondescribe`) VALUES
(1, '抗战史', 1, ''),
(2, '开心辞典', 2, '');
...
CREATE TABLE IF NOT EXISTS `ys_seminar` (
...
INSERT INTO `ys_seminar` (`seminarid`, `seminartitle`, `seminarcatid`, `seminarthumb`, `seminargallery`, `seminartpl`, `seminaruserid`, `seminarusername`, `seminardescribe`, `seminartime`, `seminarstatus`, `seminarsequence`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_special` (
...
INSERT INTO `ys_special` (`specialid`, `contentspecialid`, `contentcatid`, `contentmoduleid`, `contentuserid`, `contentusername`, `contenttitle`, `contentthumb`, `contentlink`, `contentinputtime`, `contentmodifytime`, `contentsequence`, `contentdescribe`, `contentinfo`, `contentstatus`, `contenttemplate`, `contenttext`) VALUES
...
CREATE TABLE IF NOT EXISTS `ys_specialsort` (
...
--
-- 转存表中的数据 `ys_specialsort`
--

INSERT INTO `ys_specialsort` (`sortid`, `sorttitle`, `sortthumb`, `sorttpl`, `sortseminarid`, `sortsequence`, `sortdescribe`) VALUES
...
INSERT INTO `ys_subject` (`subjectid`, `subject`) VALUES
(1, '近代史'),
(2, '科普常识'),
(3, '测试科目');
...
INSERT INTO `ys_user` (`userid`, `username`, `useremail`, `userpassword`, `usercoin`, `userregip`, `userregtime`, `userlogtime`, `usergroupid`, `usermoduleid`, `manager_apps`, `photo`, `usertruename`, `normal_favor`, `teacher_subjects`) VALUES
...
--
-- 转存表中的数据 `ys_user_group`
--

INSERT INTO `ys_user_group` (`groupid`, `groupname`, `groupmoduleid`, `groupdescribe`, `groupright`, `groupmoduledefault`, `groupdefault`) VALUES
(1, '管理员', 1, '管理员', '', 1, 0),
(8, '普通用户', 9, '普通用户', '', 0, 1),
(9, '教师', 12, '', '', 0, 0);
