...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-teach-basic-section&subjectid=<?php echo $this->tpl_var['subjectid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">科目管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?exam-teach-basic-section&subjectid=<?php echo $this->tpl_var['subjectid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">章节管理</a>
				</li>
			</ul>
