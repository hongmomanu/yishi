...
<ul>
<?php if(I('get.type') == 'inputbox'){ ?>
<li class='text'><span>发件人</span><?php echo (getuserinfo($data["from_uid"],truename)); ?></li>
<?php }else{ ?>
<li class='text'><span>收件人</span><?php echo ($data["ruser"]); ?></li>
<?php } ?>
