...
<script type="text/javascript" src="/phpapp/yishi/Public/Js/YMDClass.js"></script>
</head>
...
<ul>
<li class="text"><span>培训标题</span><input name="title" type="text" value="<?php echo ($data["title"]); ?>"/><b style="color:#F00">*</b></li>
<li class="text"><span>是否收费</span>
<select name="ismoney">
<option value="0">不收费</option>
<option value="1">收费</option></select><b style="color:#F00">*</b></li>
<li class="text"><span>费用</span><input name="money" type="text" value="<?php echo ($data["money"]); ?>"/>元<b style="color:#F00">*</b></li>
<li class="text"><span>开始时间</span><select name="year1"></select><select name="month1"></select><select name="day1"></select></li>
<li class="text"><span>结束时间</span><select name="year2"></select><select name="month2"></select><select name="day2"></select></li>
<li class="text"><span>培训学分</span><input name="score" type="text" value="<?php echo ($data["score"]); ?>"/>分(没有就不要填写)<b style="color:#F00">*</b></li>
<li class="text"><span>证书名称</span><input name="name" type="text" value="<?php echo ($data["name"]); ?>"/>(没有就不要填写)<b style="color:#F00">*</b></li>
<li class="text"><span>学分发放</span>
<select name='scoretype'>
<option value="1" <?php echo (retrunselect($data["scoretype"],1)); ?>>系统发放</option>
<option value="2" <?php echo (retrunselect($data["scoretype"],2)); ?>>手工发放</option>
</select>
</li>
...
<script>
	new YMDselect('year1','month1','day1',<?php echo date('Y',$data['starttime']); ?>,<?php echo date('m',$data['starttime']); ?>,<?php echo date('d',$data['starttime']); ?>);
	new YMDselect('year2','month2','day2',<?php echo date('Y',$data['endtime']); ?>,<?php echo date('m',$data['endtime']); ?>,<?php echo date('d',$data['endtime']); ?>);
</script>
</div>
            </div>
