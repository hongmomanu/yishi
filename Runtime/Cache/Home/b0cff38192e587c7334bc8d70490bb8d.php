...
function showHide(id){
	...
	if(name == 'none'){
        ...
        <div class="ny_R right">
        	...
        	<div  class="neirong">
        	<a href="<?php echo U('Member/password');?>">修改密码</a>
            	 <div class="reg" style="padding: 35px 0 35px 70px;">
<form action="" method="post">
<ul>
<li class="text"><span>用户名</span><input name="uname" type="text" value="<?php echo ($info["uname"]); ?>"/><b style="color:#F00">*</b></li>
<li class="text"><span>密码</span><input name="pwd" type="text" value=""/><b style="color:#F00">*</b></li>
<li class="text"><span>单位名称</span><input id=" " name="truename" type="text" value="<?php echo ($info["truename"]); ?>" /><b style="color:#F00">*</b></li>
<li class="text"><span>联系电话</span><input id=" " name="phone" type="text" value="<?php echo ($info["phone"]); ?>"/><b style="color:#F00">*</b></li>
<li class="text"><span>邮箱</span><input name="email" type="text" value="<?php echo ($info["email"]); ?>"/><b style="color:#F00">*</b></li>
<li><span>备注</span><textarea name="content"><?php echo ($info["content"]); ?></textarea></li>
