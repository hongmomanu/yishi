...
<?php if($kaohe == 0){ ?>
<li><input type="hidden" name="pxtype" value="1" /></li>
<li class="text" id="fileupload"><span>上传文件</span><input type="file" name="images" /><b style="color:#F00">*</b></li>
<li class="text" id="times"><span>培训时间</span><input type="text" name="times" value="" />分</li>
<?php }else{ ?>
<li class="text"><span>类型</span><select name="pxtype" id="pxtype" onchange="changeon()"><option value="0">请选择</option><option value="1">培训课件</option><option value="2">考试</option></select></li>
<li class="text"  id="examid" style="display:none"><span>试题</span>
<select name="examid">
<option value="0">请选择</option>
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$exam): $mod = ($i % 2 );++$i;?><option value="<?php echo ($exam["basicid"]); ?>"><?php echo ($exam["basic"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select><b style="color:#F00">*</b></li>
<script>
function changeon(){
	var t = document.getElementById("pxtype");
	if(t.options[t.selectedIndex].value == 1){
		document.getElementById("examid").style.display = 'none';
		...
		document.getElementById("examid").style.display = '';
...
<?php } ?>
<li class="text" id="fileupload" style="display:none"><span>上传文件</span><input type="file" name="images" /><b style="color:#F00">*</b></li>
<li class="text" id="times" style="display:none"><span>培训时间</span><input type="text" name="times" value="" />分</li>
