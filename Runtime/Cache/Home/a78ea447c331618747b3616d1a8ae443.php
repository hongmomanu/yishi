...
<script>
function Member(uid,pid){
	location.href='<?php echo U('Project/projectlist');?>/uid/'+uid+'/pid/'+pid;
}
function Edit(uid,id){
	location.href='<?php echo U('Project/editscore');?>/uid/'+uid+'/id/'+id;
}
function Search(){
...
function Export(){
	location.href="<?php echo U('Project/exportuser');?>/id/<?php echo I('get.id'); ?>"
}
</script>
</head>
...
<td nowrap="nowrap"><input class="bomdivcha" type="button" name="Submit2" value="查询" onClick="Search()"><input class="bomdivcha" type="button" name="Submit2" value="导出" onClick="Export()"></td>
</tr>
</table>
        	<div class="all_table">
<table cellspacing="0" cellpadding="0">
  <tr id="all_table_top">
    ...
    <td nowrap='nowrap'>所获学分</td>
    <td nowrap='nowrap'>所获证书</td>
    <td nowrap='nowrap'>考核状况</td>
...
<td nowrap='nowrap'>
<span style="cursor:pointer;" title="编辑" onclick="Member(<?php echo ($user["uid"]); ?>,<?php echo ($user["pid"]); ?>)">[详情]</span>
<span style="cursor:pointer;" title="编辑" onclick="Edit(<?php echo ($user["uid"]); ?>,<?php echo ($user["id"]); ?>)">[授予学分]</span>
</td>
