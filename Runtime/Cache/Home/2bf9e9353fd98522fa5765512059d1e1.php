...
function Edit(id)
{
	location.href='<?php echo U('Project/edititem');?>/id/'+ id;
}
...
function Del(id)
{
	...
	{
		location.href='<?php echo U('Project/delitem');?>/id/'+ id;
	}
}
function Additem(){
	location.href="<?php echo U('Project/additem');?>/pid/<?php echo ($id); ?>";
}
function Sonitem(id){
	location.href="<?php echo U('Project/sonitem');?>/sid/"+id;
}
</script>
</head>
...
<td nowrap="nowrap"></td>
<td nowrap="nowrap"></td>
<td nowrap="nowrap"><input class="bomdivcha" type="button" name="Submit2" value="添加分类" onClick="Additem()"></td>
</tr>
</table>
        	<div class="all_table">
...
<td nowrap='nowrap'>
<span style="cursor:pointer;" title="编辑" onclick="Sonitem(<?php echo ($user["id"]); ?>)">[管理]</span>
