...
<ul>
<li class='text'><span>发件人</span><?php echo (getuserinfo($data["from_uid"],uname)); ?></li>
<li class='text'><span>标题</span><?php echo ($data["title"]); ?></li>
<li><span>内容</span><?php echo ($data["content"]); ?></li>
</ul>
