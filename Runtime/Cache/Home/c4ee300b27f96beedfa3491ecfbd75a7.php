...
function Edit(id)
{
	location.href='<?php echo U('Project/starttask');?>/id/'+ id;
}
...
function Del(id)
{
	...
	{
		location.href='<?php echo U('Project/delsonitem');?>/id/'+ id;
	}
}
function Additem(){
	location.href="<?php echo U('Project/addsonitem');?>/pid/<?php echo ($id); ?>";
}
</script>
</head>
...
<table cellspacing="0" cellpadding="0">
  <tr id="all_table_top">
	...
	<td nowrap='nowrap'>最后学习时间</td>
	<td nowrap='nowrap'>上次学习时间</td>
	<td nowrap='nowrap'>结果</td>
...
<td nowrap='nowrap'><?php echo (mytasklastpost($user["id"])); ?></td>
<td nowrap='nowrap'><?php echo (staytime($user["id"])); ?>分钟</td>
<td nowrap='nowrap'><?php echo (gettaskstatus($user["id"])); ?></td>
<td nowrap='nowrap'>
<span style="cursor:pointer;" title="编辑" onclick="Edit(<?php echo ($user["id"]); ?>)">[开始学习]</span>
</td>
