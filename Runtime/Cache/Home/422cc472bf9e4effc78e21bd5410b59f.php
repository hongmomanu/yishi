...
<body>
   <!-- 配置文件 -->
    <script type="text/javascript" src="__PUBLIC__/baidu/ueditor.config.js"></script>
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="__PUBLIC__/baidu/ueditor.all.js"></script>
    <!-- 实例化编辑器 -->
    <script type="text/javascript">
        var ue = UE.getEditor('container',{initialFrameHeight:300,initialFrameWidth:750});
    </script>
<!--top-->
<div id="top">
	<div class="top">
...
<ul>
<li class="text"><span>标题</span><input name="title" type="text" value=""/><b style="color:#F00">*</b></li>
<li class="text"><span>栏目</span><select name="sort">
<option value="0">请选择</option>
<?php if(is_array($sort)): $i = 0; $__LIST__ = $sort;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sortlist): $mod = ($i % 2 );++$i;?><option value="<?php echo ($sortlist["id"]); ?>"><?php echo ($sortlist["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</select><b style="color:#F00">*</b></li>
<li><span>内容</span><script id="container" name="content" type="text/plain"></script></li>
